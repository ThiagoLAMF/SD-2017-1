...
public class RemoveAresta extends javax.swing.JFrame {
     ...
     */
    public RemoveAresta(ClienteSD conexao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("REMOVE ASSOCIAÇÃO");
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        try
        {
            if(!conexao.getClient().removeAresta(a))
            {
                JOptionPane.showMessageDialog(null, "Não foi possível remover a aresta!");
            }
            else
            {
