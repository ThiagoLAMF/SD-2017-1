 ...
 * @author ThiagoH
 */
public class InserePessoa extends javax.swing.JFrame {

    ClienteSD conexao;
    /**
     * Creates new form InsereVertice
     */
    public InserePessoa(ClienteSD conexao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("INSERIR PESSOA");
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        ...
        try
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "Não foi possível inserir! Verifique o id e descrição!");
            }
            else
            {
